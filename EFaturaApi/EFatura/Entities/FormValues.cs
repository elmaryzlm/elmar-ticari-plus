...
namespace EFaturaApi.Entities
{
    public class FormValues
    {
        ...
        public static EFaturaApi.EDMServiceMobil.GIBUSER[] vknUser { get; set; }
        public static EFaturaApi.EDMServiceMobil.GIBUSER[] gibUserList { get; set; }
