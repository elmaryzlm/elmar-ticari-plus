...
using elmarLibrary;
using EFaturaApi.EDMServiceMobil;
    ...
    public partial class SEFatura
    {
       ...
       // private string _path = System.Configuration.ConfigurationSettings.AppSettings["Path"].ToString();
        ...
        public SEFatura(string user, string password, string endpointname)
        {
            ...
            _requestHeader = new EDMServiceMobil.REQUEST_HEADERType();
        ...
        public List<FormParameters> Current_SendInvoiceMultiTest(string ublfilefullpath)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < 1; i++)
                {
                    ...
                    {
                        EARCHIVE = EFatura.AliciGB.Trim().Length == 0 ? true : false,
                        SENDER = EFatura.VergiNo,
                        FROM = EFatura.Gb,//gönderici
                        RECEIVER = receiverVKNTCKN,
                        TO = EFatura.AliciGB.Trim().Length == 0 ? EFatura.AliciEPosta : EFatura.AliciGB, //alıcı
                    };
                    cntrinvoice.CONTENT = new EDMServiceMobil.base64Binary()
                    {
                        Value = ublfilebytes
                    };
        ...
        public string CreateInvoiceTypeDataTable(string faturaNo, Int64 cariid, DataTable dtTicaret)
        {
            ...
            ublinvoice.UBLExtensions = new hm.common.Ubltr.Invoice21.UBLExtensionType[]
        {
            ...
            {
                Value = EFatura.AliciGB.Trim().Length == 0 ? "EARSIVFATURA" : "TICARIFATURA"
            };
            ...
            ublinvoice.AdditionalDocumentReference = new hm.common.Ubltr.Invoice21.DocumentReferenceType[]
        {
            ...
            ublinvoice.AccountingCustomerParty = EFatura.AliciGB.Trim().Length == 0 ? GetTC(cariid) : new hm.common.Ubltr.Invoice21.CustomerPartyType()
            {
                Party = new hm.common.Ubltr.Invoice21.PartyType()
                {
                    PartyIdentification = new hm.common.Ubltr.Invoice21.PartyIdentificationType[]
            ...
            ublinvoice.TaxTotal = new hm.common.Ubltr.Invoice21.TaxTotalType[]
        {
            ...
            File.WriteAllText(invoiceFindPath, test, Encoding.GetEncoding("iso-8859-9"));
            return invoiceFindPath;
        }

        hm.common.Ubltr.Invoice21.CustomerPartyType GetTC(Int64 cariid)
        {
            var cari = cariBilgileri.bul_cariid(cariid);
            var adresListesi = cariBilgileri.adresBilgileri.listAdresBilgileri.Where(u => u.cariid == cariid).FirstOrDefault();
            return new hm.common.Ubltr.Invoice21.CustomerPartyType()
            {
                    ...
                    PartyIdentification = new hm.common.Ubltr.Invoice21.PartyIdentificationType[]
                {
                        new hm.common.Ubltr.Invoice21.PartyIdentificationType()
                        {
                            ID = new hm.common.Ubltr.Invoice21.IDType()
                            {
                                schemeID =EFatura.AliciGB.Trim().Length==0 ? "TCKN":"VKN",
                                Value = cari.vergiNo
                            }
                        },
