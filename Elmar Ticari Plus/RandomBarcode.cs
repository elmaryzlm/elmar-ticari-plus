...
namespace Elmar_Ticari_Plus
{
    public class RandomBarcode
    {
        ...
        public RandomBarcode(string mfgNumber, string productId)
        {
            this.CountryCode = "00";
        ...
        public RandomBarcode(string countryCode, string mfgNumber, string productId)
        {
        ...
        public RandomBarcode(string countryCode, string mfgNumber, string productId, string checkDigit)
        {
            this.CountryCode = countryCode;
            this.ManufacturerCode = mfgNumber;
            this.ProductCode = productId;
